  ...
  return (
    <>
      <div className=" flex flex-col items-center bg-rafedGray-g4 py-5">
        <a href="#"><img src={"/svg/logo-footer.svg"} alt="logo footer" /></a>
        <div className="flex items-center gap-3 mt-5">
          <a href="#" className="border-l pe-2 border-rafedGray-g1">درباره ما</a>
          <a href="#">درباره ما</a>
          <a href="#" className="ms-auto"><img src={"/svg/Instgram.svg"} alt="Instgram" /></a>
      ...
      <div className="bg-rafedGray-g1 text-rafedWhite-w1 flex">
        <h6 className="m-auto py-3">Copyright © 1998-2022 rafed.net.</h6>
      </div>
    </>
  )
}
